...
const newId: string = '680916d2bb472dd9599db000';
const assortId: string = idcalc(newId,0xff);

export default function addCustomAmmoCase_46x30(logger: ILogger,customItemService: CustomItemService,tables: IDatabaseTables) {
  const newItem: NewItemFromCloneDetails = {
    ...
    locales: {
      en: {
        name: 'custom 4.6x30 HK ammo case',
        shortName: '4.6x30 HK',
        description: 'custom 4.6x30 HK ammo case'
      },
      ch: {
        name: '客制 4.6x30 HK 弹药箱',
        shortName: '4.6x30 HK',
        description: '客制 4.6x30 HK 弹药箱'
      }
    },
    overrideProperties: {
      ...
      Grids: [
        {
          ...
          _props: {
            ...
            filters: [
              {
                Filter: [ItemTpl.AMMO_46X30_AP_SX],
                ExcludedFilter: []
              }
            ],
          ...
          _props: {
            ...
            filters: [
              {
                Filter: [ItemTpl.AMMO_46X30_FMJ_SX],
                ExcludedFilter: []
              }
            ],
            isSortingTable: false,
          ...
          _props: {
            ...
            filters: [
              {
                Filter: [ItemTpl.AMMO_46X30_JSP_SX],
                ExcludedFilter: []
              }
            ],
            isSortingTable: false,
          ...
          _props: {
            ...
            filters: [
              {
                Filter: [ItemTpl.AMMO_46X30_SUBSONIC_SX],
                ExcludedFilter: []
              }
            ],
            isSortingTable: false,
          ...
          _props: {
            ...
            filters: [
              {
                Filter: [ItemTpl.AMMO_46X30_ACTION_SX],
                ExcludedFilter: []
              }
            ],
            isSortingTable: false,
  ...
  if(!createResult.success) {
    logger.error('[SPTarkovAmmoCases]：addCustomAmmoCase_46x30，Error：' + createResult.errors.join('、'));
    return;
  }
  ...
  logger.success('[SPTarkovAmmoCases]：addCustomAmmoCase_46x30，ID：' + createResult.itemId);
}
